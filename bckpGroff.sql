...
CREATE DATABASE `groff` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `groff`;
...
CREATE TABLE `CUSTOMERS` (
  ...
  `CUST_REP` int DEFAULT NULL,
  `CREDIT_LIMIT` decimal(9,2) DEFAULT NULL,
  PRIMARY KEY (`CUST_NUM`),
  KEY `HASREP` (`CUST_REP`),
  CONSTRAINT `CUSTOMERS_ibfk_1` FOREIGN KEY (`CUST_REP`) REFERENCES `SALESREPS` (`EMPL_NUM`) ON DELETE SET NULL
...
CREATE TABLE `ORDERS` (
  ...
  CONSTRAINT `ORDERS_ibfk_1` FOREIGN KEY (`CUST`) REFERENCES `CUSTOMERS` (`CUST_NUM`) ON DELETE CASCADE,
  CONSTRAINT `ORDERS_ibfk_2` FOREIGN KEY (`REP`) REFERENCES `SALESREPS` (`EMPL_NUM`) ON DELETE SET NULL,
  CONSTRAINT `ORDERS_ibfk_3` FOREIGN KEY (`MFR`, `PRODUCT`) REFERENCES `PRODUCTS` (`MFR_ID`, `PRODUCT_ID`) ON DELETE RESTRICT,
  CONSTRAINT `ORDERS_chk_1` CHECK ((`ORDER_NUM` > 100000))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `SALESREPS` (
  ...
  CONSTRAINT `SALESREPS_ibfk_1` FOREIGN KEY (`MANAGER`) REFERENCES `SALESREPS` (`EMPL_NUM`) ON DELETE SET NULL,
  CONSTRAINT `SALESREPS_ibfk_2` FOREIGN KEY (`REP_OFFICE`) REFERENCES `OFFICES` (`OFFICE`) ON DELETE SET NULL,
  CONSTRAINT `SALESREPS_chk_1` CHECK ((`EMPL_NUM` between 101 and 199))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
